...
// spaces on near everything, minimal fix
...
/*
$ clang hello-spacer-error.c
 
hello-spacer-error.c:11:13: warning: missing terminating '"' character [-Winvalid-pp-token]
            "hello,
            ^
hello-spacer-error.c:11:13: error: expected expression
hello-spacer-error.c:14:13: warning: missing terminating '"' character [-Winvalid-pp-token]
            "
            ^
